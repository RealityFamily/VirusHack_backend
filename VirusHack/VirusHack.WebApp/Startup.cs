...
//#endif
            ...
            services.AddMvc(config => config.EnableEndpointRouting = false).AddNewtonsoftJson(config => config.SerializerSettings.ReferenceLoopHandling = Newtonsoft.Json.ReferenceLoopHandling.Ignore);
        }
